...
interface Props { data: TurnPresentationResponse | null; loading: boolean; error: string | null; onRetry: () => void; }

export function DecisionResultPanel({ data, loading, error, onRetry }: Props) {
