...
function detailFixture(): AuditDetailResponse {
  return {
    ...
    retrieval_summary: { candidate_count: 0, candidates: [], mandatory_recall: [], missing_types: [], security_layer_count: 0, security_layers: [], per_layer_node_count: {}, unclassified_types: [], retrieval_visualization_path: [], final_top_k_node_ids: [], mandatory_supplemented_node_ids: [], internal_hnsw_trace_available: false, availability: "AVAILABLE" }, mandatory_recall: [], evidence_graph_summary: {}, quality_metrics: { availability: {} }, memory: {}, causal: {},
